...
class Mascota(models.Model):
    ...
    alimento = models.CharField(max_length=100, null=True,blank=True)
    datos_importantes = models.CharField(max_length=150, null=True,blank=True)
...
class Control(models.Model):
    ...
    otras_intervenciones = models.CharField(max_length=100, null=True,blank=True)
    descripcion = models.TextField(null=True, blank=True, verbose_name=('Descripción'))
